      ...
      <div class="hover-form">
        ...
        <form action="" class="hover-form-form" ref="form">
          ...
          <div class="hover-form-line">
            <input class="hover-form-button" type="button" :value="t.common.cancel" @click="onClickCancel">
            <input class="hover-form-button" type="button" :value="t.common.confirm" @click="onClickConfirm">
          </div>
        </form>
      </div>
    </div>
