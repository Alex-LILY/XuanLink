...
class PHPWebshellOneliner(PHPWebshellCommunication, PHPWebshellActions):
    ...
    conn_options: t.List[OptionGroup] = [
        ...
        },
        {
            ...
            "options": [
                Option(
                    id="http_params_obfs",
                    name="HTTP POST Param Obfuscation",
                    type="checkbox",
                    placeholder=None,
                    default_value=True,
                    alternatives=None,
                ...
                Option(
                    ...
                    type="text",
                    placeholder="Chunk size, 0=disabled; Burp Suite may not support chunked transfer",
                    default_value="0",
                    alternatives=None,
                ),
                Option(
        ...
        {
            "name": "Custom HTTP Params",
            "options": [
                Option(
                    id="http_request_method",
                    name="Custom HTTP Method",
                    type="text",
                    placeholder='e.g. "GET", defaults to password method',
                    default_value="",
                    alternatives=None,
                ),
                Option(
                    id="extra_get_params",
                    name="Extra GET Params",
                    type="text",
                    placeholder='JSON object, e.g. {"passwd": "123"}',
                    default_value="{}",
                    alternatives=None,
                ),
                Option(
                    id="extra_post_params",
                    name="Extra POST Params",
                    type="text",
                    placeholder='JSON object, e.g. {"passwd": "123"}',
                    default_value="{}",
                    alternatives=None,
                ...
                Option(
                    ...
                    name="Extra Headers",
                    type="text",
                    placeholder='JSON object or null, e.g. {"passwd": "123"}',
                    default_value="{}",
                    alternatives=None,
                ),
                Option(
    ...
    def __init__(self, session_conn: dict) -> None:
        ...
        self.http_params_obfs = session_conn.get("http_params_obfs", True)
        ...
        timeout_value = session_conn.get("timeout", "10.0")
        self.timeout: t.Union[float, None] = float(timeout_value) if timeout_value else 10.0
        ...
        try:
            ...
            if self.timeout_refresh_client:
                ...
                self.client = get_http_client(
                    {"proxy": getattr(self, "proxy", None), "https_verify": self.https_verify},
